...
class InterFaceReq():
	...
	def get_interface_cookie(self, url: str, host_key=None):
		...
		if host_key is None: assert_name = self.parsing_data.get_interface_url_host_key(url=url)
	...
	def get_interface_rep_data(self,interface_name,assert_name,host_key=None):
		
		response = self.post(interface_name=interface_name,
		                                   assert_name=assert_name,
		                                   host_key=host_key)
		...
		if json_expr is None:
			...
			return self.parsing_data.parse_response_data(response)
		
		return self.parsing_data.find_compare_data(response_data=response,
		                                           json_expr=json_expr)
